...
def populate():
    ...
    site_user1 = SiteUser.objects.get_or_create(email='johnlee@emory.edu', password='123', first_name='John', last_name='Lee', department='Math & CS', lab='Gee\'s Lab1', pi='Gee\'s PI1', research_interest='Computer science, Software Engineering', review_count='5', star=True, agreed_to_form=True)
    site_user2 = SiteUser.objects.get_or_create(email='marygreen@emory.edu', password='123', first_name='Mary', last_name='Green', department='Biostatistics', lab='Gee\'s Lab2', pi='Gee\'s PI2', research_interest='Computer science, Chemistry, Physics, Biostatistics', review_count='4', star=True, agreed_to_form=True)
    site_user3 = SiteUser.objects.get_or_create(email='arial.m@emory.edu', password='123', first_name='Arial', last_name='Martinez', department='Business', lab='Gee\'s Lab3', pi='Gee\'s PI3', research_interest='Chemistry, Physics', review_count='4', star=True, agreed_to_form=True)
    site_user4 = SiteUser.objects.get_or_create(email='rick.b@emory.edu', password='123', first_name='Rick', last_name='Buswell', department='Math & CS4', lab='Gee\'s Lab4', pi='Gee\'s PI4', research_interest='Physics, Mathematics', review_count='3', star=True, agreed_to_form=True)
    site_user5 = SiteUser.objects.get_or_create(email='benb@emory.edu', password='123', first_name='Benjamin', last_name='Bolte', department='Math & CS5', lab='Gee\'s Lab5', pi='Gee\'s PI5', research_interest='Mathematics, Physics', review_count='11', star=True, agreed_to_form=True)
    site_user6 = SiteUser.objects.get_or_create(email='emily.white@emory.edu', password='123', first_name='Emily', last_name='White', department='Math & CS', lab='Gee\'s Lab1', pi='Gee\'s PI1', research_interest='Computer science, Software Engineering', review_count='5', star=True, agreed_to_form=True)
    site_user7 = SiteUser.objects.get_or_create(email='peng.ji@emory.edu', password='123', first_name='Peng', last_name='Ji', department='Biostatistics', lab='Gee\'s Lab2', pi='Gee\'s PI2', research_interest='Computer science, Chemistry, Physics, Biostatistics', review_count='4', star=True, agreed_to_form=True)
    site_user8 = SiteUser.objects.get_or_create(email='jiulin.hu@emory.edu', password='123', first_name='Jiulin', last_name='Hu', department='Business', lab='Gee\'s Lab3', pi='Gee\'s PI3', research_interest='Statistics, mathematics', review_count='4', star=True, agreed_to_form=True)
    site_user9 = SiteUser.objects.get_or_create(email='johnny.tan@emory.edu', password='123', first_name='Johnny', last_name='Tan', department='Math & CS4', lab='Gee\'s Lab4', pi='Gee\'s PI4', research_interest='Mathematics, Finance', review_count='3', star=True, agreed_to_form=True)
    ...
    site_user11 = SiteUser.objects.get_or_create(email='larry.villagrana@emory.edu', password='123', first_name='Larry', last_name='Villagrana', department='Math & CS', lab='Gee\'s Lab1', pi='Gee\'s PI1', research_interest='Computer science, Software Engineering', review_count='3', star=True, agreed_to_form=True)
    ...
    manuscript2 = Manuscript.objects.get_or_create(id=2,keywords=['math','eco'], title = 'LAD VS PDA2******', brief_title='LAD VS PDA2', abstract='ooooooo', review_period=period[0], field='computer science', target_journal='target_journal')
    ...
    manuscript3 = Manuscript.objects.get_or_create(id=3,keywords=['math','eco','finance'], title = 'LAD VS PDA3*****',brief_title='LAD VS PDA3', abstract='ooooooo', review_period=period[0], field='computer science', target_journal='target_journal')
